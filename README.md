...
公開リーダーボード **0.39515**（ローカル検証 0.4000、2026-09-16 提出）。
Chronos-2 74% + LightGBM 26% を log 空間で混ぜ、ゼロ系列の後処理は使っていません。
上位帯は 0.37 前後なので、伸ばす余地は [手法メモ](docs/store-sales/method.md)の最後にまとめています。
